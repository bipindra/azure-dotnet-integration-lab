#!/bin/bash
# Bash deployment script for 01-Storage-Blob
...
echo ""
echo "Next steps:"
echo "1. Set the Storage Account name in appsettings.json or environment variable:"
echo "   export STORAGE__ACCOUNTNAME=${STORAGE_ACCOUNT_NAME}"
echo "   export STORAGE__CONTAINERNAME=${CONTAINER_NAME}"
echo "2. Run the application: cd src/01-Storage-Blob && dotnet run"
