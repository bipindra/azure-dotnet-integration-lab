# PowerShell deployment script for 01-Storage-Blob
param(
...
Write-Host "Container Name: $($outputs.containerName.value)" -ForegroundColor Green
Write-Host ""
Write-Host "Next steps:" -ForegroundColor Cyan
Write-Host "1. Set the Storage Account name in appsettings.json or environment variable:" -ForegroundColor White
Write-Host "   STORAGE__ACCOUNTNAME=$($outputs.storageAccountName.value)" -ForegroundColor Gray
Write-Host "   STORAGE__CONTAINERNAME=$($outputs.containerName.value)" -ForegroundColor Gray
Write-Host "2. Run the application: cd src/01-Storage-Blob && dotnet run" -ForegroundColor White
